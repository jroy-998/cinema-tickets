...
public class TicketServiceImplTest {
    ...
    @Mock
    AdultTicketPricingStrategy adultTicketPricingStrategy;

    @Mock
    ChildTicketPricingStrategy childTicketPricingStrategy;

    @Mock
    AdultTicketSeatingStrategy adultTicketSeatingStrategy;

    @Mock
    ChildTicketSeatingStrategy childTicketSeatingStrategy;
    ...
    void invalidAccount_willThrowException() {
        ...
        doThrow(new AccountIdInvalidException())
        ...
        assertThrows(InvalidPurchaseException.class, () ->
                this.ticketService.purchaseTickets(-1L, request));
    }
