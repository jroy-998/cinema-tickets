...
public class TotalTicketsValidatorTest {
  ...
  private static List<List<TicketTypeRequest>> validTicketCombinationsDataProvider() {
    return List.of(
        List.of(new TicketTypeRequest(TicketTypeRequest.Type.ADULT, 1)),
        List.of(new TicketTypeRequest(TicketTypeRequest.Type.ADULT, 24)),
        List.of(new TicketTypeRequest(TicketTypeRequest.Type.ADULT, 25)),
        List.of(
  ...
  private static List<List<TicketTypeRequest>> invalidTicketCombinationsDataProvider() {
    return List.of(
        List.of(new TicketTypeRequest(TicketTypeRequest.Type.ADULT, 26)),
        List.of(new TicketTypeRequest(TicketTypeRequest.Type.ADULT, 1000)),
        List.of(
